...
$selectMachine = "SELECT * FROM TB_CAT_FAM_CALIBER WHERE CAT_FAM_CALIBER_ID = $id;";
...
<head>
  ...
  <title>Actualizar Familia Calibre</title>
</head>
...
<div class="sidebar" id="sidebar">
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="text">ACTUALIZAR FAMILIA CALIBRE</span>
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-12 d-flex justify-content-center">
          <div class="card">
            <div class="card-body mx-5 my-2">
              <h4 class="text-center">ACTUALIZAR FAMILIA CALIBRE</h4>
              <form action="update-maestros/update-famcal.php" method="POST">
                <?php while($rowsfamcal = sqlsrv_fetch_array($queryMachine)) { ?>
                <div class="form-group my-2">
                  <input type="text" class="form-control" id="id" name="id"
                    value="<?php echo $rowsfamcal['CAT_FAM_CALIBER_ID']; ?>" hidden>
                </div>
                <div class="form-group my-2">
                  <label for="Compuestp">Familia calibre</label>
                  <input type="text" class="form-control" id="famcal" name="famcal"
                    value="<?php echo $rowsfamcal['NAME']; ?>">
                </div>
                <div class="form-group my-2">
                  <label for="Descripcion">Descripción</label>
                  <input type="text" class="form-control" id="descripcion" name="descripcion"
                    value="<?php echo $rowsfamcal['DESCRIPTION']; ?>">
                </div>
                <?php } ?>
