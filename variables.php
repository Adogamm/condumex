<?php 
    ...
    $selectVariablesBool = "SELECT TB_VARIABLE.VARIABLE_ID AS ID, TB_VARIABLE.TAG AS TAG, TB_MEASUREMENT_LIVE.VALUE AS VALUE FROM TB_MEASUREMENT_LIVE 
    INNER JOIN TB_VARIABLE ON TB_MEASUREMENT_LIVE.VARIABLE_ID = TB_VARIABLE.VARIABLE_ID
    ...
    $selectVariables = "SELECT TB_VARIABLE.VARIABLE_ID AS ID, TB_VARIABLE.TAG AS TAG, TB_MEASUREMENT_LIVE.VALUE, TB_VARIABLE.UNIT AS UNIT FROM TB_MEASUREMENT_LIVE 
        INNER JOIN TB_VARIABLE ON TB_MEASUREMENT_LIVE.VARIABLE_ID = TB_VARIABLE.VARIABLE_ID
        INNER JOIN TB_CAT_LINE ON TB_VARIABLE.CAT_LINE_ID = TB_CAT_LINE.CAT_LINE_ID WHERE TB_CAT_LINE.NAME = '$maquina' AND TB_VARIABLE.TYPE <> 'BOOL';";
