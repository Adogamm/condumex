            ...
            <div class="card-body mx-5 my-2">
              ...
              <form action="insert-maestros/insert-compuesto.php" method="POST">
                <div class="form-group my-2">
                  ...
                  <input type="number" class="form-control" id="id" name="id" placeholder="ID del nuevo compuesto" required>
                </div>
                <div class="form-group my-2">
                  <label for="Compuestp">Compuesto</label>
                  <input type="text" class="form-control" id="compuesto" name="compuesto" placeholder="Compuesto" required>
                </div>
                <div class="form-group my-2">
