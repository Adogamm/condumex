...
<div class="sidebar" id="sidebar">
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="text">NUEVA MAQUINA</span>
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-12 d-flex justify-content-center">
          <div class="card">
            <div class="card-body mx-5 my-2">
              <h4 class="text-center">AGREGAR NUEVA MAQUINA</h4>
              <form action="insert-maestros/insert-maquina.php" method="POST">
                <div class="form-group my-2">
                  <label for="ID">ID</label>
                  <input type="number" class="form-control" id="id" name="id" placeholder="ID de la nueva maquina"
                    required>
                </div>
                <div class="form-group my-2">
                  <label for="Compuestp">Maquina</label>
